...
user_image = face_recognition.load_image_file("/Users/mihailmurunov/PycharmProjects/realtime-pulse-and-respiratory"
                                               "-rate-detection/users/Mikhail.png")
...
while True:
    ...
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        ...
        pulse = np.average(rgb_small_frame)
